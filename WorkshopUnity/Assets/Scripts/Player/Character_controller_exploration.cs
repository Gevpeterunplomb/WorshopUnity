...
namespace WU.Player
{
    ...
    public class player_controller : MonoBehaviour
    {
        ...
        {
            GameController.CursorLockModePriority.AddPriority(this, PriorityTags.Small, CursorLockMode.Locked);
            GameController.CursorVisibleStatePriority.AddPriority(this, PriorityTags.Small, false);
        }
